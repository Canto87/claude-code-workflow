...
Detailed workflow documentation for each step of the phase document generator.
...
Options:
- [Approve] Save this file
- [Edit] Request changes
- [Skip] Don't create this file
```
...
2. AI regenerates affected sections
3. Shows updated preview
4. Repeat until approved or skipped

---

## Phase Division Criteria

When proposing phases, consider:
...
|-----------|-------------|
| Foundation First | Data models, base interfaces before features |
| Dependency Order | Dependent features after their dependencies |
| Risk Isolation | High-risk items in dedicated phases |
| Deliverable Chunks | Each phase produces usable functionality |
